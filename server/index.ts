// the main server file. Contains all the API endpoints (routes).
// e.g. when the frontend calls /api/facilities, the code handling 
// that is in here. This is the largest and most important backend file
